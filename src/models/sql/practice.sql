...
-- Could alternatively use JSONB in vehicles table for features array
...
-- Set role defaults for users table
DO $$
DECLARE
...
BEGIN
    ...
    IF user_role_id IS NOT NULL THEN
        ALTER TABLE users ALTER COLUMN role_id SET DEFAULT user_role_id;
    END IF;
END $$;
